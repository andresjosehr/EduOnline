...
<main class="text-grey">
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center font-weight-bold text-blue-sky mb-5">Cambio de contraseña</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5">
                    <div class="alert alert-success cambio_pass_success_messaje d-none" role="alert">
            ...
            <div class="row justify-content-center pb-3">
                <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 d-flex align-items-center">
                    <form class="col-12 px-0" id="cambio_pass" method="POST" data-parsley-validate="">
                        ...
                        <button onclick="ValidarGeneral('POST', '{{Request::root()}}/cambio-pass', '', 'cambio_pass')" type="button" class="col-12 btn btn-info btn-login text-center font-weight-bold">Resetear contraseña</button>
                    </form>
                </div>
            </div>
